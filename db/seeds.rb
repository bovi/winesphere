...
scale1 = Scale.create(name: 'winesphereScale01', booth: booth1, offset: 0, calibration: 1)
scale2 = Scale.create(name: 'winesphereScale02', booth: booth2, offset: 0, calibration: 1)
